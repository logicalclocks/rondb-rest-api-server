...
func (rc *RouterConext) SetupRouter() {
	...
	rc.Engine.GET("/"+rc.APIVersion+"/:db/:table/"+pkread.DB_OPERATION, pkread.PkReadHandler)
	rc.Engine.GET("/"+rc.APIVersion+"/"+batchops.DB_OPERATION, batchops.BatchOpsHandler)
}
